    ...
    ExpandableRecyclerViewAdapter<BLEDeviceAdapter.ServicesViewHolder, BLEDeviceAdapter.CharacteristicViewHolder>(serviceList)
{
    ...
    class CharacteristicViewHolder(itemView: View) : ChildViewHolder(itemView) {
        ...
        val characteristicName: TextView = itemView.title
        val properties: TextView = itemView.device
        val valueBle: TextView = itemView.valeur
        val buttonRead: TextView = itemView.bRead
        val buttonWrite: TextView = itemView.bWrite
        val buttonNotify: TextView = itemView.bNotify
    }
       ...
       childIndex: Int)
   {
        ...
        holder.buttonWrite.setOnClickListener {
            ...
            val editView = View.inflate(context, R.layout.ble_alertdialog, null)
